...
import 'widget/paddle_button.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showNotificationWithActions() async {
    AndroidNotificationActionInput androidNotificationActionInput = AndroidNotificationActionInput(
        label: "label "
    );
    const AndroidNotificationDetails androidNotificationDetails =
  ...
  Future<void> _showMessagingNotification() async {
    ...
    const Person coworker = Person(
      key: '2',
      uri: 'tel:9876543210',
      icon: FlutterBitmapAssetAndroidIcon('icons/app_icon.png'),
    );
    ...
    await Future<void>.delayed(const Duration(seconds: 5), () async {
      messages.add(Message("I'm so sorry!!! But I really like thai food ...",
          DateTime.now().add(const Duration(seconds: 10)), null));
